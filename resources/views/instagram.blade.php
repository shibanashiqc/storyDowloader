...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
      ...
      Online download videos from YouTube, All in One DL, Download videos from twitter, instagram, facebook, mxtakatak, josh, ipl, ted, tiktok - Get2Mate">
      ...
      <meta name="msapplication-TileImage" content="{{ env('APP_URL') }}/images/logo-default-200x34.png">
      <meta name="theme-color" content="#ffffff">
      <meta name="viewport" content="width=device-width ,  initial-scale=1 ,  shrink-to-fit=no">
      <div class="snackbars" id="form-output-global"></div>
        <!--coded by theofficialvkr-->
...
<link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css">
    ...
    </div><a style="margin-left:76;" href="#" class="header__logo">STATUS DOWNLOADER</a>
...
<div class="nav__perfil">
    ...
    <div>
        <a href="#" class="nav__name">STATUS DOWNLOADER</a>
...
<form method="post" action="{{ route('instagramSearch') }}">
@csrf
<div class="searchBar">
<input id="searchQueryInput" type="text" name="searchQueryInput" placeholder="Search" value="{{ $query }}" />
...
<div class="container-fluid" id="all-supported-sites">
<div class="container">
<div class="row">
...
<div class="copyright">
Copyright © 2022 STATUS DOWMLOADER - All rights reserved
</div>
</footer>
<script>
